    ...
    public class NReinas {
        ...
        public static void main(String[] args) {
            ...
            long startTime = System.currentTimeMillis(); // Inicio del tiempo de ejecución
            ...
            long memoryUsed = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory(); // Memoria utilizada en bytes
